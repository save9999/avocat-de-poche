      ...
      <main id="main-content" className="mx-auto max-w-4xl px-6 py-12" tabIndex={-1}>
        ...
        <div className="rounded-3xl border border-paper-200 bg-white p-8 sm:p-10 space-y-8 text-midnight-700 leading-relaxed">
          ...
          <section aria-labelledby="hebergement">
            ...
            <p className="mt-1">Site : <a href="https://vercel.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-midnight-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brass-500 rounded">vercel.com</a></p>
          </section>
          ...
          <section aria-labelledby="responsabilite">
            ...
            <div className="rounded-xl border border-brass-200 bg-brass-50 p-4 text-brass-900 text-sm" role="note" aria-label="Avertissement important">
          ...
          <section aria-labelledby="donnees-ml">
            ...
            <p className="mt-2">Pour plus d'informations, consultez notre <Link href="/confidentialite" className="underline hover:text-midnight-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brass-500 rounded">politique de confidentialité</Link>.</p>
          </section>
